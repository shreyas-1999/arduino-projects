...
void loop() 
{
  ...
  if (distance > 15 && distanceL > 20 && distanceR > 20)
  {
    forward();
  } 
  if(distanceL<19 && distanceR<19 && distance>15)
  {
    forward();
    delay(1000);
  }
  if (distance < 14 && distanceL >19 && distanceR > 19)
  {
    stopcar();
    delay(500);
    reverse();
  ...
  if(distanceR < 19 && distanceL >19 && distance >15)
  {
    stopcar();
    delay(500);
    right();
  ...
  else if(distanceL < 19 && distanceR >19 && distance >15)
  {
    stopcar();
    delay(500);
    left();
